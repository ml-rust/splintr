...
- `from_json` reads `model.merges` without materializing a `serde_json::Value` per entry, and sizes its merge-rank tables up front, retiring 13-30% fewer instructions per load.
