...
`vocab-qwen` feature; that is what re-exports these constants and can load them.

## Provenance

Extracted from `Qwen/Qwen3-8B` on HuggingFace. The vocabulary is upstream's, not splintr's, and
