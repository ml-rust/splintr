...
`vocab-cl100k` feature; that is what re-exports these constants and can load them.

## Provenance

Extracted from OpenAI, `https://openaipublic.blob.core.windows.net/encodings/cl100k_base.tiktoken`. The vocabulary is upstream's, not splintr's, and
